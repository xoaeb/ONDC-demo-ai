...
const RequestMoney: React.FC = () => {
  ...
  const handleRequest = () => {
    ...
    toast({
      title: "Request Sent",
      description: `You requested ₹${amount} from ${selectedContact.name}`
    });
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      <div className="px-6 pt-12 pb-6 relative border-b border-gray-100">
        ...
        <h1 className="text-xl font-medium text-dark-900 text-center">Request Money</h1>
      </div>
      
      <div className="p-6">
        {selectedContact ? (
          <div className="flex flex-col items-center mb-6 animate-fade-in">
            <div className="w-16 h-16 rounded-full flex items-center justify-center text-white bg-blue-500 mb-2">
            ...
            <div className="mb-6 max-h-60 overflow-y-auto">
              {filteredContacts.length > 0 ? (
                filteredContacts.map(contact => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-full flex items-center justify-center text-white bg-blue-500 mr-3">
                      {contact.avatar}
                    </div>
                    <div>
