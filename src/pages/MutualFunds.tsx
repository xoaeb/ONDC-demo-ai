      ...
      <header className="mb-6">
        ...
        <div className="relative mb-4">
          <Input
            ...
            className="pl-10 pr-4 py-2 rounded-lg border-gray-200 focus:border-teal focus:ring-1 focus:ring-teal"
          />
            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 mb-2">
                  {fund.category} • Min ₹{fund.minInvestment}
                </p>

                <div className="flex items-center gap-4 mt-2">
                  <div
                    className={`${getRiskColor(fund.risk)} text-sm font-medium`}
                  >
                    {fund.risk} Risk
                  </div>
                  <div className="text-gray-500 text-sm">AUM: {fund.aum}</div>
                </div>
              </div>
                ...
                <div className="flex items-center mb-1">
                  <span
                    className={`font-semibold text-lg ${
                      fund.trending === "up" ? "text-green-600" : "text-red-500"
                    }`}
                  >
                    {fund.returns}%
                  </span>
